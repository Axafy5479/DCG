...
public class Ability_Shanghai_723704 : IAbilityBase //,ISelectableAbility
{
    ...
    {
        if (typeof(Ability_Shanghai_723704).GetInterface(typeof(ISelectableAbility).ToString()) != null)
        {
            return new AbilityBook_Selectable(() => new Ability_Shanghai_723704(), true, 723704, CheckSelectable);
        }
        else
        {
            return new AbilityBook(() => new Ability_Shanghai_723704(), false, 723704);
        }
    }
